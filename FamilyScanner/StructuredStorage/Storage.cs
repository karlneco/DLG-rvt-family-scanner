...
namespace StructuredStorage
{
    ...
    public class Storage : StorageBase, IDisposable
    {
        ...
        private PartitionsStorage _partitions;
         ...
         : base(fileName)
        {
            ...
            PartitionsInfo = new PartitionsStorage(FileName, StorageRoot);
            if (StorageRoot != null)
            {
                CloseStorageRoot(StorageRoot);
            }
        ...
        public PartitionsStorage PartitionsInfo
        {
            get
            {
                if (_partitions.IsInitialized == false)
                {
                    _partitions.ReadPartitions();
                }
                return _partitions;
            }
            set
